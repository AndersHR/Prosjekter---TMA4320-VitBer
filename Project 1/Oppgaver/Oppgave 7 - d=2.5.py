from numpy import empty, array, pi, sin, exp, geomspace, dot, eye, argmin, zeros, savez
...
if __name__ == "__main__":
    ...
    lambdas = geomspace(1e-11,3*1e-9, n_lambda)
    ...
    ax.scatter(lambdas[1:], errors_by_lambda[1:], c='r', s=30)
    ax.set_xscale('log')
    ax.set_xlim(1e-11,3*1e-9)
    ax = set_axis_specs(ax, r'$\lambda$', r'# min |Error|', 23, 23)
    plt.show()

    file = rel_path + r'/Data_files/Oppgave7d25'
